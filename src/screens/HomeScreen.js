        ...
        <div className="homeScren">
            <Fade>
                <div className="homeScreen__top">
                    <h4>
                        We are working hard to put the health and well-being of
                        our partners and customers first in all that we do.
            ...
            <div className="homeScreen__featured">
                <Fade>
                    <Featured
                        ...
                        info="Say yes to sips of delight with our Honey Almond milk Flat White and new Honey Almond milk Cold Brew."
